...
{
    private readonly Guid UserId = Guid.Parse("78bd97ce-f7a3-4513-a471-080c93af9398");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Pet>().HasData(
                    new Pet() { Id = 1, Name = "Gianni", Age = 10, Weight = 19, PhotoUrl= "/images/gianni.jpg", BreedId = 1, UserId = UserId },
                    new Pet() { Id = 2, Name = "Nina", Age = 8, Weight = 24, PhotoUrl = "/images/nina.jpg", BreedId = 1, UserId = UserId },
                    new Pet() { Id = 3, Name = "Cati", Age = 8, Weight = 33.5m, PhotoUrl = "/images/cati.jpg", BreedId = 2, UserId = UserId },
                    new Pet() { Id = 4, Name = "Cheshire", Age = 20, Weight = 12, BreedId = 3, UserId = UserId },
                    new Pet() { Id = 5, Name = "Garfield", Age = 20, Weight = 12, BreedId = 4, UserId = UserId },
                    new Pet() { Id = 6, Name = "Bugs", Age = 40, Weight = 25, BreedId = 5, UserId = UserId },
                    new Pet() { Id = 7, Name = "Roger", Age = 35, Weight = 31, BreedId = 6, UserId = UserId }
                    );
